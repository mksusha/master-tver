...
export default function MapSection() {
    return (
        <section
            aria-label="Офис и карта компании Гермес"
        ...
        >
            <div className="relative w-full max-w-[1600px] bg-secondary rounded-3xl shadow-sm overflow-hidden text-center">
                ...
                <div className="py-6 md:py-8 border-b border-gray-100">
                    ...
                    <address className="mt-1 text-lg md:text-xl font-medium text-gray-800 not-italic">
                ...
                <div className="relative w-full h-[400px] md:h-[500px]">
                    <iframe
                        ...
                        allowFullScreen
                        loading="lazy"
                        title="Карта офиса компании Гермес в Твери"
