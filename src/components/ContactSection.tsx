                ...
                <div className="flex flex-col justify-center bg-secondary p-8 md:p-12">
                    ...
                    <div className="flex flex-col gap-3 mb-8">
                        <div className="flex items-center gap-3 text-lg text-gray-800">
                            ...
                            <a href="tel:+79001234567" className="hover:text-[#B49C6C] transition">
                                +7 (900) 123-45-67
                            </a>
                        </div>
                        ...
                        <div className="flex items-center gap-3 text-lg text-gray-800">
                            ...
                            <a href="mailto:design@gmail.com" className="hover:text-[#B49C6C] transition">
                                design@gmail.com
                            </a>
                        </div>
                        ...
                        <div className="flex items-center gap-4 mt-2 ">
                            <a
                                ...
                                className="flex items-center gap-2 text-gray-800 hover:text-[#0088cc] transition"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 240 240"
                                    className="w-6 text-brand h-6"
                                    fill="currentColor"
                                >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-2 text-gray-800 hover:text-[#25D366] transition"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 448 512"
                    ...
                    <form className="flex flex-col md:flex-row gap-3">
                        ...
                        <button
                            type="submit"
                            className="px-6 py-3 rounded-2xl bg-gradient-to-r from-[#B49C6C] to-[#ccb689] text-white font-medium hover:opacity-90 transition"
                        >
                            Заказать звонок
                        </button>
                    </form>
