...
const projects = [
    { src: "/first-blok10.jpg", alt: "Пример интерьера: Гостиная с индивидуальным дизайном" },
    ...
    { src: "/first-blok5.jpg", alt: "Пример интерьера: Гостиная с индивидуальным дизайном" },
