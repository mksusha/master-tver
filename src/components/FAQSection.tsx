...
const faqs = [
    ...
    },
    {
        ...
        answer:
            "Стоимость рассчитывается индивидуально в зависимости от площади помещения, используемых материалов, оборудования и в целом уровня сложности. После согласования проекта, мы предоставляем прозрачную и детальную смету на все работы.",
    },
    {
